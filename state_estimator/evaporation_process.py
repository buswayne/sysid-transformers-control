...
@jit
def simulate_evaporation_process(u, perturbation, save_params=False, process_noise = False):
    # Hyperparams
    Ts = 1
...
if __name__ == "__main__":
    ...
    system_trajectory = simulate_evaporation_process(u_forced, perturbation)
