...
from dataset import WHDataset, CSTRDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_onestep_cstr_normed_no_skip", metavar='S',
                        help='Saved model name')
    parser.add_argument('--in-file', type=str, default="ckpt_onestep_cstr_no_normed_no_skip", metavar='S',
    ...
    train_ds = CSTRDataset(nx=cfg.nx, nu=2, ny=2, seq_len=cfg.seq_len,
    ...
    val_ds = CSTRDataset(nx=cfg.nx, nu=2, ny=2, seq_len=cfg.seq_len,
                       mag_range=cfg.mag_range, phase_range=cfg.phase_range,
    ...
    model_args = dict(n_layer=cfg.n_layer, n_head=cfg.n_head, n_embd=cfg.n_embd, n_y=2, n_u=2, block_size=cfg.block_size,
