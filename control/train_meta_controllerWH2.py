...
from wh_dataset_old import WHDataset_old
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_wh2_testing", metavar='S',
                        help='Saved model name')
    parser.add_argument('--in-file', type=str, default="ckpt_wh2_testing", metavar='S',
    ...
    train_ds = WHDataset_old(seq_len=cfg.seq_len, fixed_system= True, tau = 0.5)
    ...
    val_ds = WHDataset_old(seq_len=cfg.seq_len, fixed_system= True, tau = 0.5)
