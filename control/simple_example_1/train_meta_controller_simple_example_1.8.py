...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_controller_simple_example_1.18", metavar='S',
                        help='Saved model name')
    parser.add_argument('--in-file', type=str, default="ckpt_controller_simple_example_1.18", metavar='S',
