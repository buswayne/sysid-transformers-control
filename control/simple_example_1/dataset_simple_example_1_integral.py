...
class SimpleExample1Dataset(IterableDataset):
    ...
    def __iter__(self):
        ...
        while True:  # infinite dataset
            ...
            start_idx = 0#np.random.randint(0, len(e_v)-n_context)
            ...
            if self.return_y:
                ...
                yield torch.tensor(u_L), torch.tensor(e_v)


if __name__ == "__main__":
    train_ds = SimpleExample1Dataset(seq_len=300, normalize=False, return_y=True, signal='white noise', use_prefilter=True)
