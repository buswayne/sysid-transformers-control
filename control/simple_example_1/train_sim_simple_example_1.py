...
if __name__ == '__main__':
    ...
    # Create data loader
    train_ds = SimpleExample1Dataset(seq_len=cfg.seq_len_ctx + cfg.seq_len_new, normalize=True, signal='white noise', use_prefilter=True)
    ...
    val_ds = SimpleExample1Dataset(seq_len=cfg.seq_len_ctx + cfg.seq_len_new, normalize=True, signal='white noise', use_prefilter=True)
    ...
    def estimate_loss():
        ...
        for eval_iter, (batch_y, batch_u, batch_r) in enumerate(val_dl):
            ...
            batch_y_new = batch_y[:, cfg.seq_len_ctx:, :] # from u(m) to y(m)
