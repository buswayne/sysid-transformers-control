...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_simple_example_1_prefilter4", metavar='S',
                        help='Saved model name')
    parser.add_argument('--in-file', type=str, default="ckpt_simple_example_1_prefilter4", metavar='S',
