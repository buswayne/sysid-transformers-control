...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_wh", metavar='S',
                        help='Saved model name')
    parser.add_argument('--in-file', type=str, default="ckpt_wh", metavar='S',
    ...
    train_ds = WHDataset(seq_len=cfg.seq_len, fixed_system= True, tau = 1, fixed_u)
