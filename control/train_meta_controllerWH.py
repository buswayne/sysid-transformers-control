...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_wh1.1", metavar='S',
                        help='Saved model name')
    parser.add_argument('--in-file', type=str, default="ckpt_wh1.1", metavar='S',
    ...
    train_ds = WHDataset(seq_len=cfg.seq_len, fixed_system= True, fixed_u = True, tau = 1)
