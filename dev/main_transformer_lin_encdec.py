...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_encdec_lin", metavar='S',
    ...
    parser.add_argument('--ny', type=int, default=1, metavar='N',
                        help='model order (default: 5)')
    parser.add_argument('--seq-len-ctx', type=int, default=300, metavar='N',
...
#                        help='If True, keep the same model all the times')
    ...
    def estimate_loss():
        ...
        for eval_iter, (batch_y, batch_u) in enumerate(val_dl):
            ...
            batch_y_sim = model(batch_y_ctx, batch_u_ctx, batch_y_new, batch_u_new)
